...
public class TopicRepositoryTests {
    ...
    public void shouldReturnOpenTopicsByCategory() {
        ...
        List<TopicsOpenByCategory> openTopics = this.topicRepository.findOpenTopicsByCategory(TopicStatus.NOT_ANSWERED);
        ...
        assertThat(openTopics.get(0).getQuantity()).isEqualTo(2);

        assertThat(openTopics.get(1).getCategoryName())
                .isEqualTo("Front-end");
        assertThat(openTopics.get(1).getQuantity()).isEqualTo(1);
    }
}
